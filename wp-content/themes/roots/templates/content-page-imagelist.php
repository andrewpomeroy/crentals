			...
			if ($theattachments) {
				...
				foreach ($theattachments as $post) {
						...
						<div class="demo-image">
							...
							<textarea class="demo-image__url copy-this-url" onclick="this.focus();this.select()" readonly="readonly"><?php $imgsrc = wp_get_attachment_image_src( $post->ID, 'full', false ); echo $imgsrc[0] ?></textarea>
