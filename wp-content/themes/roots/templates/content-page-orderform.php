				...
				<ng-form name="orderFormForm" novalidate>
					...
					<table class="order-form table">
						...
						<tbody ng-repeat="group in itemData">
							...
							}"><input type="number" ng-model="item.qty" ng-change="changeQty(item)" dynamic-name="item.name + '_qty'"/ ng-pattern="/^[0-9][0-9]*$/" ><span ng-show="orderFormForm[item.name + '_qty'].$error.required">Required</span><span ng-show="orderFormForm[item.name + '_qty'].$invalid">integer</span></td>
